...
<section class="wrap reveal sec"><div class="g2">
 ...
 ${panel("The 'vote chori' dispute","Allegation, response, and what is not settled",`<ul class="clean"><li><b>Allegation (Aug-Sep 2025):</b> Congress said about 1 lakh fake or invalid voters in Mahadevapura helped the BJP win in 2024, and that 6,018 votes were targeted for deletion in Aland (a seat Congress won in 2023).</li><li><b>Commission's response:</b> called the claims baseless, asked for a signed declaration, and said nobody can delete votes online. It admitted unsuccessful deletion attempts in Aland in 2023 and filed an FIR.</li><li><b>Voter-roll revision, Maharashtra draft:</b> 2.06 crore names (21%) were not in the draft roll; that is a draft, before claims and objections.</li></ul>`,"I found no independent finding of systematic fraud and no independent clearing of the allegations either. Both sides are recorded here.",["vc_adr","vc_tr","vc_out"])}
${panel("Federal check: the audit body","The CAG's findings sit on both sides",`<p class="muted" style="margin:0">The CAG's Union accounts report (April 2026) found Rs 54,282 crore in outstanding utilisation certificates. Delhi's BJP government cited a similar CAG finding against the earlier AAP government. Karnataka's guarantee schemes were noted by the CAG for raising the revenue deficit.</p>`,"Oversight bodies find gaps at every level of government.",["cag_w","cash_dp"])}
...
<section class="wrap reveal"><figure class="quote"><blockquote>&ldquo;We must forge ahead with our own capacity to think, or else we shall perish under the weight of our own hollowness.&rdquo;</blockquote><figcaption>Dr. A. P. J. Abdul Kalam</figcaption></figure></section>
${pager("reck")}`;
